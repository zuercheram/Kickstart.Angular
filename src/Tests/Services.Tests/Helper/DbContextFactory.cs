...
public static class DbContextFactory
{
    ...
    public static ApplicationDbContext CreateApplicationDbContextInMemory(string databaseName = "Kickstart.Angular-Test", bool createNewDatabase = true)
    {
        var builder = new DbContextOptionsBuilder<ApplicationDbContext>();
    ...
    public static ApplicationDbContext CreateApplicationDbContextLocalDb(string databaseName = "Kickstart.Angular-Test", bool createNewDatabase = true)
    {
        var builder = new DbContextOptionsBuilder<ApplicationDbContext>();
    ...
    public static void UseTestSqliteInMemoryDb(this DbContextOptionsBuilder builder, string databaseName = "Kickstart.Angular-Test")
    {
    ...
    public static void UseTestInMemoryDb(this DbContextOptionsBuilder builder, string databaseName = "Kickstart.Angular-Test")
    {
        builder.UseInMemoryDatabase(databaseName);
    }

    public static void UseTestLocalDb(this DbContextOptionsBuilder builder, string databaseName = "Kickstart.Angular-Test")
    {
        builder
            .UseSqlServer(
